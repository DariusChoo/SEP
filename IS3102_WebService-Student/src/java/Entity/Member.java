...
public class Member {
    ...
    public Member(String name, String email, Integer loyaltyPoints, ArrayList<String> wishList, 
            Double cumulativeSpending, String phone, String address, String city, Integer age, Integer income)
    {
        this.name = name;
        this.email = email;
